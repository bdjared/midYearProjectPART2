...
public class MyWorld extends World{
    ...
    private Object[] round4 = new Object[] {new Integer(20), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon(), new blueBalloon()};
    private Object[] round5 = new Object[] {new Integer(25), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon(), new greenBalloon()};
